        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card bg-light">
                    <div class="card-body">
                        <h5>ID Peminjaman     : {{ $peminjaman->peminjaman_id }}</h5>
                        <h6>Nama Pengguna     : {{ $peminjaman->user->user_nama }}</h6>
                        <h6>Tanggal Peminjaman: {{ \Carbon\Carbon::parse($peminjaman->peminjaman_tglpinjam)->format('d-m-Y') }}</h6>
                        <h6>Denda: Rp {{ number_format($peminjaman->peminjaman_denda, 2, ',', '.') }}</h6>
